...
this.evercookie_cache = function(name, value)
{
	if (typeof(value) != "undefined")
	{
		...
		img.src = _ec_path + 'evercookie_cache.php?name=' + name;
	}
	else
	{
		...
		$.ajax({
			url: _ec_path+'evercookie_cache.php?name=' + name,
...
this.evercookie_etag = function(name, value)
{
	if (typeof(value) != "undefined")
	{
		...
		img.style.visibility = 'hidden';
		img.style.position = 'absolute';
		img.src = _ec_path + 'evercookie_etag.php?name=' + name;
	}
	else
	{
		// interestingly enough, we want to erase our evercookie
		...
		$.ajax({
			url: _ec_path+'evercookie_etag.php?name=' + name,
			success: function(data) {
				// put our cookie back
...
this.evercookie_lso = function(name, value)
{
	...
	swfobject.embedSWF(_ec_path+"evercookie.swf", "swfcontainer", "1", "1", "9.0.0", false, flashvars, params, attributes);
}
...
this.evercookie_png = function(name, value)
{
	if (document.createElement('canvas').getContext)
	{
		if (typeof(value) != "undefined")
		{
			...
			img.style.visibility = 'hidden';
			img.style.position = 'absolute';
			img.src = _ec_path+'evercookie_png.php?name=' + name;
		}
		else
		{
...
this.evercookie_silverlight = function(name, value) {
    ...
    */
        var source = _ec_path+"evercookie.xap";
