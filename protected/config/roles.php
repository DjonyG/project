...
return array(
    ...
    'manageAccountAccess'=>array(
        'type'=>CAuthItem::TYPE_OPERATION,
        'description'=>'Manage self account access',
        'children'=>array(),
        'bizRule'=>null,
        'data'=>null,
    ),
    ...
    'copyingFiles'=>array(
        'type'=>CAuthItem::TYPE_OPERATION,
        'description'=>'Can copy files',
        'children'=>array(),
        'data'=>null,
        'bizRule'=>'',
//        'bizRule'=>'return Yii::app()->user->getParam("enable_copying_files", false);',
    ),
    'updateProfile'=>array(
        'type'=>CAuthItem::TYPE_OPERATION,
