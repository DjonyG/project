...
Yii::import('application.components.widgets.gridView.GridView');

class AdminGridView extends GridView {

    public $type = 'striped bordered condensed';
    public $enablePageSizeSelector = array(
        '25'=>25,
        '50'=>50,
        '100'=>100,
        '500'=>500,
    ...
    public function init()
    {
        ...
        $popover = Yii::app()->booster->popoverSelector;
        $tooltip = Yii::app()->booster->tooltipSelector;
