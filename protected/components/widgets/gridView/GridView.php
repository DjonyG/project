...
class GridView extends TbGridView {
    ...
    {
        if($this->enablePageSizeSelector === true) {
            $this->enablePageSizeSelector = [
                '10'=>10,
                '25'=>25,
                '50'=>50,
                '100'=>100,
        ...
        if($this->enablePageSizeSelector && $this->dataProvider->pagination!=false) {
            if($pageSize = Yii::app()->request->getParam('pageSize')) {
                ...
                if(!isset($this->enablePageSizeSelector[$this->dataProvider->pagination->pageSize])) {
                    $this->dataProvider->pagination->pageSize = current($this->enablePageSizeSelector);
                }
            }
        }
                ...
                $this->dataProvider->pagination->getPageCount() > 1))
        {
            ...
            if(count($this->groupActions)) {
                ...
                $this->widget('TbButton', array(
                    ...
                    'label'       => Yii::t('main', 'submit', [], null, null, true),
